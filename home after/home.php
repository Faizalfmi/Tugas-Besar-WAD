...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="home.php" class="navbar-brand ms-lg-5">
            <img src="img/logo-ans.jpeg" width="150" height="50">
        </a>
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="price.html" class="dropdown-item">Product</a>
                        <a href="blog.html" class="dropdown-item">Service</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">Contact Us</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Nama</a>
                    <div class="dropdown-menu m-0">
    ...
    <div class="container">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <br>
            <h5 class="display-5 mb-0"><strong>Our Partner</h5></strong>
            </br>
        </div>

        <div class="container">
            <div class="row align-items-center">
                <div class="col"><img src="img/Yokke.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/Total.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/Jantung.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/Master-System.jpeg" width="150" height="100"></div>
            </div>
        </div>

        <div class="container">
            <div class="row align-items-center"></br></br><center></center>
                <div class="col"><img src="img/Harkit.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/Mandiri.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/BPJS.jpeg" width="150" height="100"></div>
                <div class="col"><img src="img/HDI.jpeg" width="150" height="100"></div>
            </div>
        </div>
    </div>
</div>
