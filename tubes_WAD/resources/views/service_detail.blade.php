...
<body>
    ...
    <div class="container-fluid p-5 hero-header mb-5" style="background-color: #172F36;">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">UTP Cabling Installation</h1>
    ...
    <div class="container-fluid">
        ...
        <table>
            ...
            <tr>
                <td style="text-align: left; width: 500px;">{{ $tampil->service}}</td>
                <td>{{ $tampil->jumlah}}</td>
                <td>{{ $tampil->satuan}}</td>
                <td>{{ $tampil->harga}}</td>
                @if(Auth::user())
                <td><form action="/edit_service_page/{{ $tampil->id}}">
                    ...
                    <br>
                    <form action="/delete_service/{{ $tampil->id}}">
