...
<head>
    <meta charset="utf-8">
    <title>ANS | {{ $data->product_name}}</title>
            ...
            <div class="col-6">
                <form action="/product_edit_page/{{ $data->id }}" enctype='multipart/form-data' method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control form-control-readonly" value="{{ $data->product_name}}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="category"><b>Kategori Produk</b></label>
                        <input type="text" name="category" class="form-control"value="{{ $data->product_category}}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="harga"><b>Harga</b></label>
                        <input type="text" name ="harga" class="form-control" value="{{ $data->price}}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="stok"><b>Stock</b></label>
                        <input type="number" id='stok' name="stok" class="form-control" value="{{ $data->stock}}" readonly>
                    </div>
                    <div class="mb-3">
