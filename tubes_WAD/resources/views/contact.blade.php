                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-5 text-white mb-md-4">Contact</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-0">Get in touch with us</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="bg-light rounded p-5">
                        <form>
                            <div class="row g-3">
                                <div class="col-6">
                                    <input type="text" class="form-control border-0 px-4" placeholder="First Name*" style="height: 55px;">
                                </div>
                                <div class="col-6">
                                    <input type="email" class="form-control border-0 px-4" placeholder="Last Name*" style="height: 55px;">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control border-0 px-4" placeholder="Your Email" style="height: 55px;">
                                </div>
                                <div class="col-6">
                                    <input type="email" class="form-control border-0 px-4" placeholder="Website" style="height: 55px;">
                                </div>
                    ...
                    <div class="bg-light rounded p-5">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>Jl. Maulana Hasanudin No.38A, Kp. Cipondoh Rt. 005 Rw. 008, Cipondoh - Kota Tangerang 15148</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="text-start">
                                ...
                                <span>021 55712013</span>
                            </div>
                        </div>
                        <div>
                            <iframe class="position-relative w-100"
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15866.20013575064!2d106.6757387!3d-6.190911!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xfac6a42994c21fdd!2sPT%20Adita%20Nusantara%20Solution!5e0!3m2!1sen!2sid!4v1673149099363!5m2!1sen!2sid"
