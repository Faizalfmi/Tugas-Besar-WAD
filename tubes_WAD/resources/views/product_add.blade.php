...
<body>
    ...
    <div class="container-fluid p-5 hero-header mb-5" style="background-color: #172F36;">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">Adding Product</h1>
                <a href="" class="h4 text-white">Add new product(s) to the database</a>
    ...
    <div class="container">
            ...
            @if (count($errors) > 0)
                            ...
                            @endif
                <form action="/product_add" enctype='multipart/form-data' method="POST">
                    @csrf
                    @method("POST")
