                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>
	                            	Masukkan data anda untuk membuat akun admin
                            	</p>
                            </div>
                        </div>
                    </div>
                            ...
                            @endif
			                    <form role="form" action="/register" method="post" class="login-form">
			                    	...
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="name" placeholder="Nama..." class="name form-control" id="name">
			                        </div>
			                        <div class="form-group">
                                    ...
                                    <div class="form-group">
			                        	...
			                        	<input type="text" name="hp" placeholder="No HP..." class="hp form-control" id="hp">
			                        </div>
			                        <div class="form-group">
                                    ...
                                    <div class="form-group">
			                        	<label class="sr-only" for="confirm">Konfirmasi Password</label>
			                        	<input type="password" name="confirm" placeholder="Konfirmasi Password..." class="confirm form-control" id="confirm">
			                        </div>
