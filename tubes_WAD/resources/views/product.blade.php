    ...
    <div class="container-fluid p-5 hero-header mb-5" style="background-color: #172F36;">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">Our Products</h1>
                <a href="" class="h4 text-white">Products we usually use for our solution</a>
        ...
        <div class='row row-cols-3 gap-6' style="margin-left: 10%;">
            ...
            <div class='card' style="width: 25%;">
                ...
                <div class='card-footer'>
                    <a href='/product_detail/{{ $tampil->id}}' button class='btn btn-primary' type='Details'>Detail</a>
                    @if(Auth::user())
                    <a href='/product_delete/{{ $tampil->id}}' button class='btn btn-danger' type='Delete'>Delete</a>
                    @endif
                </div>
            </div>
            @endforeach
